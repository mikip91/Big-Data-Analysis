...
data=pd.read_csv("D:\\MS\\2ndSem\\DIC\\\Lab2\\output\\crawlword.txt", sep='\t', encoding='ISO-8859-1')
...
top_ten_data.to_csv("D:\\MS\\2ndSem\\DIC\\\Lab2\\output\\top_10_crawlword.txt",sep='\t',header=False, index=False)
...
top_ten_data.to_csv("D:\\MS\\2ndSem\\DIC\\\Lab2\\output\\top_50_crawlword.txt",sep='\t',header=False, index=False)