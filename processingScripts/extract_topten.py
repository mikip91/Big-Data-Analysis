...
top_ten_data.to_csv("D:\\MS\\2ndSem\\DIC\\\Lab2\\output\\top_10_nyco.txt",sep='\t',header=False, index=False)
...
top_ten_data.to_csv("D:\\MS\\2ndSem\\DIC\\\Lab2\\output\\top_50_nyco.txt",sep='\t',header=False, index=False)