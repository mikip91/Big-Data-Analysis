...
End_date <- "2019-04-09"
tweets <- searchTwitter('Politics', n=5000, lang="en", since=Start_date, until=End_date)
...
write.table(ProcessedTweets$text, file = "D:/MS/2ndSem/DIC/Lab2/twitterData/tweets.txt", sep="\t", col.names = F, row.names = F, quote = F) 
