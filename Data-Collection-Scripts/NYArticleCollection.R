...
# Topic - Politics
# Subtopic - Trump, Administration, government
...
# Collecting articles
NYDataframe <- as_search(q = "government", begin_date = Start_Date, end_date = End_Date, all_results = TRUE)
...
write.csv(NYDataframe, file = "D:/MS/2ndSem/DIC/Lab2/newsData/Newgovt.csv")

# Reading Articles
Articles <- read.csv(file="D:/MS/2ndSem/DIC/Lab2/newsData/Oldgovt.csv", header=TRUE, sep=",")
...
write.csv(Articles, file = "D:/MS/2ndSem/DIC/Lab2/newsData/Oldgovt.csv")
